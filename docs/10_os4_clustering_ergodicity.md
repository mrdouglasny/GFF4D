# OS4: Clustering and Ergodicity (needs revision)
...
| `freeCovarianceℂ_bilinear_timeTranslation_invariant` | $C(T_sf, T_sg) = C(f,g)$ |
...
| [`gff_exp_time_translated_memLp_two`](../OSforGFF/OS4_Ergodicity.lean#L131) | $e^{\langle T_s\phi, f\rangle} \in L^2(\mu)$ |
| [`gff_exp_L2_norm_constant`](../OSforGFF/OS4_Ergodicity.lean#L228) | $\|e^{\langle T_s\phi, f\rangle}\|_{L^2}$ is constant in $s$ |
| [`time_average_memLp_two`](../OSforGFF/L2TimeIntegral.lean#L348) | $\frac{1}{T}\int_0^T e^{\langle T_s\phi, f\rangle}\,ds \in L^2(\mu)$ |
| [`gff_product_expectation_stationarity`](../OSforGFF/OS4_Ergodicity.lean#L383) | $\mathbb{E}[A(T_s\phi)\overline{A(T_u\phi)}]$ depends only on $s-u$ |
| [`gff_covariance_continuous`](../OSforGFF/OS4_Ergodicity.lean#L511) | $s \mapsto \mathrm{Cov}(A(T_s\phi), A(\phi))$ is continuous |
| [`L2_time_average_variance_bound`](../OSforGFF/OS4_Ergodicity.lean#L591) | $\mathrm{Var}(\frac{1}{T}\int_0^T A_s) \le \frac{1}{T^2}\int_0^T\!\int_0^T \lvert\mathrm{Cov}(s,u)\rvert\,ds\,du$ |
| [`double_integral_decay_bound`](../OSforGFF/OS4_Ergodicity.lean#L370) | $\int_0^T\!\int_0^T(1+\lvert s-u\rvert)^{-3}\,ds\,du \leq 2TC$ |
| [`clustering_implies_covariance_decay`](../OSforGFF/OS4_Ergodicity.lean#L736) | $\lvert\mathrm{Cov}(s,u)\rvert \leq c(1+\lvert s-u\rvert)^{-\alpha}$ |
| [`variance_decay_from_clustering`](../OSforGFF/OS4_Ergodicity.lean#L900) | $\mathrm{Var}(\text{time avg}) = O(1/T) \to 0$ |
| [`OS4'_implies_OS4`](../OSforGFF/OS4_Ergodicity.lean#L1084) | Single-function ergodicity $\implies$ linear-combination ergodicity |
| [`OS4''_implies_OS4'`](../OSforGFF/OS4_Ergodicity.lean#L1332) | Polynomial clustering $\implies$ single-function ergodicity |
| [`OS4''_implies_OS4_Ergodicity`](../OSforGFF/OS4_Ergodicity.lean#L1344) | Polynomial clustering $\implies$ full ergodicity |
| [`OS4_PolynomialClustering_implies_OS4_Ergodicity`](../OSforGFF/OS4_Ergodicity.lean#L1353) | **Main ergodicity theorem**: polynomial clustering ($\alpha=6$) $\implies$ `OS4_Ergodicity` |
