...
Many unused axioms and definitions have been removed. See git history for details.
-/
...
which uses the spatial regularization approach (BlueprintAlt namespace). -/

-- Note: freeCovarianceKernel_integrable is now defined in CovarianceMomentum.lean
